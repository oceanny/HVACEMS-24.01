...
//	@GetMapping("/exitForm")
//	public ModelAndView exitForm(HttpSession session, ModelAndView mnv) throws Exception {
//		String url = "/security/exitForm";
//		
//		String adminId = (String)session.getAttribute("loginUser");
//		String adminPwd = adminService.getPwd(adminId);
//		
//		mnv.addObject("adminId", adminId);
//		mnv.addObject("adminPwd", adminPwd);
//		mnv.setViewName(url);
//		
//		return mnv;
//	}
//	
//	@PostMapping("/exit")
//	public String findPwd(String adminId) throws Exception {
//		String url = "/security/exit";
//		adminService.exit(adminId);
//		return url;
//	}
