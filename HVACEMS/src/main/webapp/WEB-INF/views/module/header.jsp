   ...
   <div class="wrapper">
      ...
      <nav class="main-header navbar navbar-expand navbar-white navbar-light">
         ...
         <ul class="navbar-nav ml-auto">
			...
			<a class="nav-link" data-toggle="dropdown" href="" onclick="readAlarms();">
         ...
         <div class="sidebar">
            ...
            <div class="logout-box user-panel mt-3 pb-3 mb-3 d-flex">
				...
				<div class="info info-box">
					...
					<!-- <button onclick="location.href='<%=request.getContextPath() %>/exitForm.do';" class="btn btn-xs btn-primary col-xs-3" type="button">탈퇴</button>  -->
				</div>
			</div>
            <!-- /.sidebar-menu -->
         </div>
